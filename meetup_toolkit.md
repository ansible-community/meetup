...
- [Milestones](#milestones)
  ...
  * [On the day of the event](#on-the-day-of-the-event)
...
- [Gain awareness of Ansible meetups](#gain-awareness-of-ansible-meetups)
  ...
  * [1. Attending the meetups](#attending-the-meetups)
  * [2. Presenting at the meetup](#presenting-at-the-meetup)
  * [3. Hosting a meetup](#hosting-a-meetup)
  * [4. Organizing a meetup](#organizing-a-meetup)
...
- [Start Planning](#start-planning)
  ...
  * [1.Online Meetup](#online-meetup)
  * [2.In Person Meetup](#in-person-meetup)
...
- [During the Event](#during-the-event)
  ...
  * [Good to follow Guidelines](#good-to-follow-guidelines)
  * [How to remain connected with the attendees?](#how-to-remain-connected-the-attendees)
  * [Presentation Templates](#presentation-templates)
  * [Past Talks](#past-talks)
- [Post Event Activities](#post-event-acitivies)
  * [Feedback](#feedback)
- [Resources](#resoucres)
  * [Community Contributions to the Resources Repository](#community-contributions-to-the-resources-repository)
  * [Email templates](#email-templates)
  * [Speaker Outreach for the first time](speaker-out-reach-for-the-first-time)
  * [Follow-up email for the speaker](#follow-up-email-for-the-speaker)
  * [Email template once the person confirms for the talk](#email-template-once-the-person-confirms-for-the-talk)
  * [Email template once the event is announced](#email-template-once-the-event-is-announced)
  * [Email template for venue scout for the first time](#email-template-for-venue-scout-for-the-first-time)
  * [Follow-up email for the venue scout](#follow-up-email-for-the-venue-scout)
  * [Email template for after-venue confirmation](#email-template-for-after-venue-confirmation)
  * [Email template for reaching out Sponsor for the first time](#email-template-for-reaching-out-sponsor-for-the-first-time)	
  * [Follow-up email with the sponsor](#follow-up-email-with-the-sponsor)
  * [Follow up email with the venue sponsor post confirmation](#follow-up-email-with-the-venue-sponsor-post-confirmation)
  * [Follow up email with the food sponsor post confirmation](#follow-up-email-with-the-food-sponsor-post-confirmation)
  * [Follow up email with the Group Support sponsor post confirmation](#follow-up-email-with-the-group-support-sponsor-post-confirmation)
...
### Speaker Outreach for the first time
...
### Follow-up email for the speaker
...
### Email template once the speaker confirms for the talk
...
### Email template once the event is announced
...
### Email template for venue scout for the first time
...
### Follow-up email for the venue scout
...
### Email template for after-venue confirmation
...
### Email template for reaching out Sponsor for the first time
...
### Follow-up email with the sponsor
...
### Follow up email with the (venue) sponsor post confirmation
...
### Follow up email with the (food) sponsor post confirmation
...
### Follow up email with the (Group Support) sponsor post confirmation
...
### Promotion Pre-Event : post templates
...
```
Ahh, Ansible should be able to solve your automation requirements. Why? Let’s ask the people who develop Ansible. Join us at the Ansible Community meetup, on {date} at {place}, {time} {time zone}.
```
...
### Promotion during the event : post templates


```
It is always so nice to see people writing their first Ansible Playbook, {ansible meetup group name} at {place}.
```

```
We have started with our {group_name} meetup with a full house. Now is the time to automate things with Ansible.  #community #opensource
```
